package com.seminario.tasks.Utils;
...
import com.seminario.tasks.Utils.exception.AppException400BadRequest;
import com.seminario.tasks.Utils.exception.AppException401Unauthorized;
import com.seminario.tasks.Utils.exception.AppException403Forbidden;
import com.seminario.tasks.Utils.exception.AppException404NotFound;
import com.seminario.tasks.Utils.exception.AppException500InternalServerError;
...
public class Utils {
	...
	public static <T> ResponseEntity<ResponseBean<T>> handle(Exception e, String msg) {
		...
		if (e instanceof AppException400BadRequest) {
			body = new ResponseBean<>(false, "Revisar los datos: " + e.getMessage().toLowerCase(),
